...
## Indicates whether to scan mapped network drives -> impact
...
Set-MpPreference -ExclusionPath "%ALLUSERSPROFILE%\NTuser.pol"
Set-MpPreference -ExclusionPath "%SystemRoot%\System32\GroupPolicy\User\registry.pol"
Set-MpPreference -ExclusionPath "%windir%\Security\Database\*.chk"
Set-MpPreference -ExclusionPath "%windir%\Security\Database\*.edb"
Set-MpPreference -ExclusionPath "%windir%\Security\Database\*.jrs"
Set-MpPreference -ExclusionPath "%windir%\Security\Database\*.log"
Set-MpPreference -ExclusionPath "%windir%\Security\Database\*.sdb"
Set-MpPreference -ExclusionPath "%windir%\SoftwareDistribution\Datastore\Datastore.edb"
Set-MpPreference -ExclusionPath "%windir%\SoftwareDistribution\Datastore\Logs\Edb.chk"
Set-MpPreference -ExclusionPath "%windir%\SoftwareDistribution\Datastore\Logs\Res*.jrs"
Set-MpPreference -ExclusionPath "windir%\SoftwareDistribution\Datastore\Logs\Res*.log"
Set-MpPreference -ExclusionPath "%windir%\SoftwareDistribution\Datastore\Logs\Tmp.edb"
